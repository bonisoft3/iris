...
#manifestGen: G={
	...
	_buildCrossEntry: {
		...
		out: {
			...
			// Defaulted so manifests generated by a pre-class bayt
			// still load (they render as build-class, the old behavior).
			class: [
		...
		for n, t in G.project.targets if t != null
			...
			if _emitsSrcs[n] {
				(n): synthetics: srcs: {
					...
					env: {}
					// Synthetic views are packaging stages, never runtime-class.
					class: "build"
