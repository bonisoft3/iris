...
_e4_m: files: bare: {[!~"^(name|project|dir|activate|srcs|outs|env|visibility|class|up|emitsSrcs|synthetics|deps|sameProjectDeps|transitiveDeps|transitiveCrossDeps|chainedDeps|cmds|cache|upClosure)$"]: _|_}
