...
_e4_m: files: bare: {[!~"^(name|project|dir|activate|srcs|outs|env|visibility|emitsSrcs|synthetics|deps|transitiveDeps|transitiveCrossDeps|chainedDeps|cmds|cache)$"]: _|_}
